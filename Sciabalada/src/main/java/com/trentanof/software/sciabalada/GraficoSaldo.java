...
public class GraficoSaldo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficosaldo);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_to_image:
                Intent intent = new Intent(GraficoSaldo.this, GoogleImageGraphActivity.class);
