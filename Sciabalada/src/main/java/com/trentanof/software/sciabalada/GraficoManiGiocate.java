...
public class GraficoManiGiocate extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficomanigiocate);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_to_image:
                Intent intent = new Intent(GraficoManiGiocate.this, GoogleImageGraphActivity.class);
