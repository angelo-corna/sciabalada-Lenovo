...
public class GraficoPartiteGiocate extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficopartitegiocate);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_to_image:
                Intent intent = new Intent(GraficoPartiteGiocate.this, GoogleImageGraphActivity.class);
