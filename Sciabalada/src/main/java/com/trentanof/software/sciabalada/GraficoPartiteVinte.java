...
public class GraficoPartiteVinte extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficopartitevinte);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_to_image:
                Intent intent = new Intent(GraficoPartiteVinte.this, GoogleImageGraphActivity.class);
