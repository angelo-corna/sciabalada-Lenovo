...
public class GraficoPPartiteVinte extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficoppartitevinte);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_to_image:
                Intent intent = new Intent(GraficoPPartiteVinte.this, GoogleImageGraphActivity.class);
